...
'>
    <!-- header -->
	<?php $_template = new Smarty_Internal_Template("hu2014-page-header.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
	<!-- /header -->

	<!-- progressbar -->
	<?php $_template = new Smarty_Internal_Template("hu2014-page-progressbar.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
	<!-- /progressbar -->
    ...
    <div data-role="content" class="content">
      ...
      <!-- question -->
      <?php $_template = new Smarty_Internal_Template("hu2014-page-question.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
	  <!-- /question -->
	</div> <!-- /content -->	
	
	<!-- footer -->
	<?php $_template = new Smarty_Internal_Template("hu2014-page-footer.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
	<!-- /footer -->
...
">
	    ...
	    <button type="submit" data-theme="c" value="submit-value" data-icon="arrow-r" data-iconpos="right"><?php echo $_smarty_tpl->getVariable('text')->value['page_important_skip'];?>
</button>
