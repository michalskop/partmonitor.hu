	  ...
	  <div class="question ui-body ui-body-{$partner['swatch_question_body']}">	  
	    <ul data-role="listview" data-theme="{$partner['swatch_question_body']}">
	      {foreach $missing as $m}
	        <li data-theme="c"><img src="../../image/1x1.png" class="psp2013vk-sprite psp2013vk-sprite-{$m->friendly_name}-80" alt="{$m->last_name}"/>
	        <h3>{$m->last_name|truncate:35:"...":true}</h3>
	        <div class="small">{$m->first_name|truncate:45:"...":true}</div>
	        <p class="ui-li-aside">
