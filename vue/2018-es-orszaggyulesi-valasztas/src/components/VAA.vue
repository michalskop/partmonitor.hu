                    ...
                    <b-carousel-slide :question="question" class="carousel-item">
                        <div class="row d-flex align-items-stretch item-inner item-inner-upper">
                            ...
                            <div class="col-sm-10 col-md-8 align-self-center">
                                ...
                                <div class="d-flex justify-content-center text-dark">
                                    <p class="p-2 vaa-width">{{ question.description }}</p>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        data: function () {
            // var checked = {}
            // for (var i = 0; i < questions.length; i++) { checked[questions[i].id] = {1: true} }
            return {
                questions,
                // checked,
                progress: 1,
...
<style>
    ...
    .item-inner-upper {
        height: calc(4/5*(100vh - 56px - 8px));
    }
    .item-inner-lower {
        height: calc(1/5*(100vh - 56px - 8px));
    }
    .page {
        height: 100vh;
    }
